...
export class WindChimeRod extends EventTarget {
    ...
    constructor(position: Vector3, length: number, radius: number, scale: number, scene: Scene) {
        super()
        this._length = length;
        this._radius = radius * scale;
        ...
        this._rod = MeshBuilder.CreateTube('rod', {
            ...
            sideOrientation: Mesh.DOUBLESIDE, radius: this._radius
        });
